...
TEST_F(NotationViewInputControllerTests, WheelEvent_ScrollVertical)
{
    ...
    EXPECT_CALL(m_view, moveCanvas(0, 180, true))
    .Times(1);
    ...
    EXPECT_CALL(m_view, moveCanvas(0, 80, true))
    .Times(1);
    ...
    EXPECT_CALL(m_view, moveCanvas(0, 50, true))
    .Times(1);
...
TEST_F(NotationViewInputControllerTests, WheelEvent_ScrollHorizontal)
{
    ...
    EXPECT_CALL(m_view, moveCanvas(120, 0, true))
    .Times(1);
